              ...
              children: [
                          ...
                          Container(
                              ...
                              child: Text('Driver',
                                  style: TextStyle(
                                      ...
                                      fontFamily: 'Poppins'))),
                          Container(
                            margin: EdgeInsets.only(right: w * 0.16),
                            child: Text(
                              'Azaz Khan',
                              style: TextStyle(
                                  fontSize: t * 11.5, fontFamily: 'Poppins'),
                            ),
                          ),
                        ],
                      ),
                      Container(
                          margin: EdgeInsets.fromLTRB(w * 0.15, 0, 0, 0),
                          child: Image.asset(
                ...
                Container(
                  child: Row(
                    children: [
                      Container(
                        decoration: BoxDecoration(
                            color: Color(0xffF86B6B), shape: BoxShape.circle),
                        width: w * 0.1,
                        height: h * 0.025,
                        child: Icon(Icons.check,color: Colors.white,size: h*0.02,),
                      ),
                      SizedBox(
                        width: w * 0.02,
                      ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: Color(0xff03645D).withOpacity(0.2))),
                  height: h * 0.083,
                  width: w * 0.89,
                  child: Row(
                    children: [
                      Container(
                          margin: EdgeInsets.fromLTRB(w * 0.03, 0, w * 0.02, 0),
                          child: Image.asset(
                      ...
                      Container(
                        margin: EdgeInsets.fromLTRB(w * 0.0, 0, 0, 0),
                        child: Column(
                          children: [
                            Container(
